...
class DataSet {
    ...
    public function addUser($newId, $name, $pass) {
        $statement = $this->_dbHandle->prepare("INSERT INTO aee513.Users (UsersId, Username, Password, IsAdmin) VALUES ($newId,?,?,0);");// adds a new non admin user using the imputed fields
        //sql injection blocking
